...
pubDate: 2026-01-22
tags: ['music', 'tools', 'web', 'react', 'nextjs', 'typescript']
---
...
- Live tool: [bpm.s33g.uk](https://bpm.s33g.uk)
- Source code: [github.com/S33G/bpm-tool](https://github.com/S33G/bpm-tool)
