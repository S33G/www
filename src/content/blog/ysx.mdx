...
1. **YAML is not a programming language** — It's a data serialization format. Using it to describe UI logic is like using TOML to write your business logic. Technically you *can*, but should you?
...
The project is beautifully organized:
