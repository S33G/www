...
It's become a genre. The clickbait screenshots of ChatGPT writing a Python script. The grumbling of engineers about how we're automating ourselves into obsolescence. The non-technical hot takes from people who just discovered that computers can output English.

It is exhausting. And honestly, it’s mostly human slop, the organic equivalent of AI-generated filler, just recycled anxiety dressed up as insight for clicks.
...
Three years later, junior developers still exist. They just start from a different baseline. The tool eliminates the tedious part — memorising syntax, typing boilerplate — and the bottleneck moves upstream.
